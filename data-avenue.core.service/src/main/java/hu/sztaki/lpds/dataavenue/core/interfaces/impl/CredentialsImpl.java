...
public final class CredentialsImpl implements Credentials {
	...
	public CredentialsImpl() { map = new HashMap<String, String>(); }
	public CredentialsImpl(final Map<String, String> map) {	this.map = map != null ? new Hashtable<String, String>(map) : null; }
	...
	@Override public String optCredentialAttribute(final String key, final String defaultValue) { 
		if (map == null || map.get(key) == null || "".equals(key)) return defaultValue;
